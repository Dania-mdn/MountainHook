...
public class Left : MonoBehaviour
{
    ...
    public GameObject Joistick_Left;
    public float stopping = 0.04f;
    Vector3 dir;
    float angle;
    ...
    void Update()
    {
        if (bull != null)
        {
            PlayerPrefs.SetInt("mousDoun1", 1);
            line.enabled = true;
        ...
        {
            PlayerPrefs.DeleteKey("mousDoun1");
            Joint.enabled = false;
            line.enabled = false;
            if (Input.GetKey(KeyCode.Mouse0) && Joistick_Left.activeSelf == true)
            {
